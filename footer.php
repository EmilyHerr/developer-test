...
<div id="wdac-instructions" class="uk-modal">
    <div class="uk-modal-dialog">
        <button type="button" class="uk-modal-close uk-close"></button>
        <div class="uk-modal-header">
            <p class="uk-h1">Instructions</p>
        </div>
        <p>Please do the below tasks in any order except for the bonuses. You may use Google or another search engine. You may use HTML, CSS, JavaScript, jQuery, or PHP to complete these tasks. The site must be mobile responsive and display well on a phone and tablet. Only complete the bonuses if you have completed all other items.</p>
        <ol class="uk-text-left uk-list uk-list-striped">
            <li>Make the link that opened this instruction modal into a button with an orange background that matches the parent background, white borders, and white text using the class <span class="uk-text-danger" style="display: inline-block">.wdac-button</span> attached to it. Make sure it has a smooth hover transition effect that inverts the colors (white background and orange text).</li>
...
<p class="uk-margin-bottom-remove uk-margin-top-remove">&copy; <?php echo date('Y'); ?> Web Design and Company</p>
